	...
	<div class="listHeader" :class="listHeader.class">
		...
		<div class="btns">
			<template v-if="listHeader.createlib">				
				<div class="create" style="background-image: url('static/images/sys/create.png');"   @click="createlib">
					新建库
				</div>
			</template>
			<template v-if="listHeader.addbtn">
				<div class="create" style="background-image: url('static/images/sys/create.png');" @click="addbtn">
					{{listHeader.addbtn}}
				</div>
			</template>
			...
			<template v-if="listHeader.autH">
				<div class="create" style="background-image: url('static/images/sys/create.png');" @click="createAut">
					{{listHeader.autH}}
				</div>
			</template>
		</div>
...
<style lang="css">
	.create{
		/* background-image: url("static/images/sys/create.png"); */
	}
	div.listHeader{
		width:auto;
		height: 0.54rem;
