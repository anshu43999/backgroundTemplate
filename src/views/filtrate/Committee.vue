...
return {
    NowUrl : '', // 当前  下一页 url
    queryUrl : this.apiRoot +'jianliA01/selectZFWNameAndCardList',  // 精确查询
    AllUrl : this.apiRoot + 'jianliA01/selectZFWAllList' , //all
    FilterUrl : this.apiRoot + 'jianliA01/screenZFWList', //筛选框
