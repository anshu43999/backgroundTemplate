...
//监听属性 类似于data概念
        ...
        methods: {
            ...
            dispose(res){
                if (res.status === 200) {
                    // console.log(res);
                    this.sexData.太原市.SI.MAN = res.data.sexRatio1;
                    this.sexData.太原市.SI.WOMAN = res.data.sexRatio2;
                    this.ageData.太原市.SI.THIRTYDOWN = res.data['30'];
                    this.ageData.太原市.SI.FORTY = res.data['40'];
                    this.ageData.太原市.SI.FIFTY = res.data['50'];
                    this.ageData.太原市.SI.SIXTY = res.data['59'];
                    this.ageData.太原市.SI.SIXTYUP = res.data['60'];
                    this.dutyAgeData.太原市.SI.TWODOWN = res.data.dutyLevelTwo;
                    this.dutyAgeData.太原市.SI.FIVE = res.data.dutyLevelFive ;
                    this.dutyAgeData.太原市.SI.TEN = res.data.dutyLevelNine;
                    this.dutyAgeData.太原市.SI.TENUP = res.data.dutyLevelTen;

                    this.eduData.太原市.SI.BENKE =res.data.University;
                    this.eduData.太原市.SI.YANJIUSHENG =res.data.postgraduate;
                    this.eduData.太原市.SI.TOTAL =res.data.total;


                    this.jobLevelData.太原市.SI.MAN = {
                    ...
                    this.jobLevelData.太原市.SI.WOMAN = {
