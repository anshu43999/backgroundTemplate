...
//监听属性 类似于data概念
        ...
        methods: {
            ...
            dispose(res){
                if (res.status === 200) {
                    this.sexData.太原市.JIAN.MAN = res.data.sexRatio1;
                    this.sexData.太原市.JIAN.WOMAN = res.data.sexRatio2;
                    this.ageData.太原市.JIAN.THIRTYDOWN = res.data['30'];
                    this.ageData.太原市.JIAN.FORTY = res.data['40'];
                    this.ageData.太原市.JIAN.FIFTY = res.data['50'];
                    this.ageData.太原市.JIAN.SIXTY = res.data['59'];
                    this.ageData.太原市.JIAN.SIXTYUP = res.data['60'];
                    this.dutyAgeData.太原市.JIAN.TWODOWN = res.data.dutyLevelTwo;
                    this.dutyAgeData.太原市.JIAN.FIVE = res.data.dutyLevelFive ;
                    this.dutyAgeData.太原市.JIAN.TEN = res.data.dutyLevelNine;
                    this.dutyAgeData.太原市.JIAN.TENUP = res.data.dutyLevelTen;

                    this.eduData.太原市.JIAN.BENKE =res.data.University;
                    this.eduData.太原市.JIAN.YANJIUSHENG =res.data.postgraduate;
                    this.eduData.太原市.JIAN.TOTAL =res.data.total;


                    this.jobLevelData.太原市.JIAN.MAN = {
                    ...
                    this.jobLevelData.太原市.JIAN.WOMAN = {
